        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-sm-9">
              <p style={styles.heading} className="d-sm-block d-none font-family text-center fw-bolder heading my-3" >
                ADMIN MANAGEMENT PAGE
              </p>
              <p style={styles.heading} className="d-sm-none d-block font-family text-center fw-bolder fs-5 my-2" >
                ADMIN MANAGEMENT PAGE
              </p>
                ...
                <table className="table table-bordered text-center table-center font-family">
                  ...
                  <tbody className="align-middle">
                    <tr>
                      ...
                      <td>{email}</td>
                      <td>
                        <button onClick={() => { setModel(true); }} style={styles.tableBtn} className="btn form-control shadow-none rounded-0" >
                          UPDATE
                        </button>
                      </td>
                    </tr>
              ...
              <div style={styles.modelDiv2} className="row p-3 my-sm-5">
                ...
                <form method="post" onSubmit={(e) => { handleform(e); }} >
                  <div className="col-sm-12 my-2">
                    ...
                    <input type="text" onChange={(e) => { setUsername(e.target.value); }} value={username} className="form-control shadow-none font-family mt-2 rounded-0" />
                  </div>
                  <div className="col-sm-12 my-2">
                    <label className="d-sm-block d-none font-family model-label">
                      PASSWORD
                    ...
                    <input type="text" onChange={(e) => { setPassword(e.target.value); }} className="form-control shadow-none font-family mt-2 rounded-0" required />
                  </div>
                  <div className="col-sm-12 my-2">
                    <label className="d-sm-block d-none font-family model-label">
                      EMAIL
                    ...
                    <input type="email" onChange={(e) => { setEmail(e.target.value); }} value={email} className="form-control shadow-none font-family mt-2 rounded-0" />
                  </div>
