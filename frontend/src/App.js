...
import Allimagemanagement from "./admin/Allimagemanagement";
...
import Forgetpage from "./admin/Forgetpage";
...
import Resetpage from "./admin/Resetpage";
...
function App() {
  ...
  const [gReset, setGReset] = useState(null)
  const [gAdminName, setGAdminName] = useState(JSON.parse(window.localStorage.getItem("admin_name")))
  const [gEmail, setGEmail] = useState(JSON.parse(window.localStorage.getItem("g_email")))

  return (
    <>
      <Router>
        <context.Provider value={{ gAdmin, setGAdmin, gMessage, setGMessage, gReset, setGReset, gAdminName, setGAdminName, setGEmail }}>
          <Routes>
            ...
            <Route path={`/forgotlink/${gEmail}`} element={<Resetpage />} />
            ...
            <Route path="/allimagemanagement" element={<Allimagemanagement />} />
