                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-12 p-0">
                            <img className="img-responsive" src={mainImage} alt="image not found" />
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-6 p-1">
                            <img className="images-div1 img-responsive" src={imageOne} alt="image not found" />
                        </div>
                        <div className="col-sm-6 px-sm-3 px-1">
                            <div className="col-sm-12 d-flex">
                                <div className="col-sm-6 p-1">
                                    <img className="images-div2 img-responsive" src={imageTwo} alt="image not found" />
                                </div>
                                <div className="col-sm-6 p-1">
                                    <img className="images-div3 img-responsive" src={imageThree} alt="image not found" />
                                </div>
                            </div>
                            <div className="col-sm-12 p-1">
                                <img className="images-div4 img-responsive" src={imageFour} alt="image not found" />
                            </div>
                        </div>
                    </div>
                </div>
