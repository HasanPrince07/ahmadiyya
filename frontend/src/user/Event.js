...
function Event() {
    ...
    const [eventBtn1, setEventBtn1] = useState(true)
                                ...
                                <>
                                    {eventData.map((data, key) => (
                                        <div key={data._id} style={{ backgroundColor: eBColor }} className="d-sm-flex d-block col-sm-12 justify-content-between align-items-center p-3 mt-2">
                                            ...
                                            <p style={styles.eventsName} className="d-sm-none d-block font-family text-center fw-bolder fs-5 m-0">Event Name</p>
