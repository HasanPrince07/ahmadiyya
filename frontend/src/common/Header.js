                ...
                <div className="container-fluid">
                    <div style={{ backgroundColor: headingBColor }} className="row">
                        <div className="col-sm-12 d-flex justify-content-center align-items-center p-2">
                            <img className="col-sm-1 col-2" src={logo} alt="Not found" />
                    ...
                    <div className="row">
                        <div style={{ backgroundColor: linksBColor }} className="col-sm-12 justify-content-center d-sm-flex d-none">
                            <ul className="p-0 my-3">
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/" className="text-decoration-none px-4 mx-3 py-1">Home</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/about" className="text-decoration-none px-4 mx-3 py-1">About</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/images" className="text-decoration-none px-4 mx-3 py-1">Image</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/event" className="text-decoration-none px-4 mx-3 py-1">Event</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/result" className="text-decoration-none px-4 mx-3 py-1">Result</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/review" className="text-decoration-none px-4 mx-3 py-1">Review</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/facility" className="text-decoration-none px-4 mx-3 py-1">Facility</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/history" className="text-decoration-none px-4 mx-3 py-1">History</NavLink></li>
                                <li className="font-family fw-bold d-inline-block"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/contact" className="text-decoration-none px-4 mx-3 py-1">Contact</NavLink></li>
                            </ul>
                        </div>
                        <div style={{ backgroundColor: linksBColor }} className="col-12 justify-content-end d-sm-none d-flex py-2">
                            <div style={styles.headerBtn} id="header-btn" className="col-1">
                                <button onClick={headerBtnFn} className="btn p-1 shadow-none d-flex">
                                    <img className="img-responsive header-btn-img" src="media/headerbtn.png" alt="Not found" />
                                </button>
                            </div>
                        </div>
                        {open ? <></> : <>
                            <div style={{ backgroundColor: linksBColor }} className="col-12 d-sm-none d-block header-link-div">
                                <ul className="ps-3 my-2">
                                    ...
                                    <li className="font-family fw-bold d-block py-2"><NavLink style={({ isActive }) => (isActive ? { color: aLinkColor, backgroundColor: aLinkBColor } : { color: linksColor })} to="/images" className="text-decoration-none px-2 py-1 fs-5">Image</NavLink></li>
