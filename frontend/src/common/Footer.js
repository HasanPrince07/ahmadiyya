    ...
    return (
        <>
            <section style={{ backgroundColor: BColor }} id="footer">
                    ...
                    <div className="row p-sm-5 p-3">
                        <div className="col-sm-4 d-flex align-items-center">
                            <div className="col-sm-3 col-2">
                                <img className="img-responsive" src={FImage} alt="Not found" />
                            </div>
                ...
                <div style={styles.ownerDiv} className="container-fluid">
                    <div className="row">
                        <div className="col-sm-12">
                            <p className="d-sm-block d-none font-family text-center owner-name my-1">Develop by Mohammad Hasan</p>
                            <p className="d-sm-none d-block font-family text-center my-1">Develop by Mohammad Hasan</p>
                        </div>
                    </div>
                </div>
            </section>
